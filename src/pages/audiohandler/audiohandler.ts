...
@Component({
  selector: 'page-audiohandler',
  templateUrl: 'audiohandler.html',
})
export class AudiohandlerPage{
   @ViewChild('localVideo') localVideo;
  @ViewChild('selfVideo') selfVideo;
number ;remotename;hideavatar = false;remoteavatar ; mutehideend=true; hidetext = true ; text ="Connecting" ;  incoming ; hideaccept = true ; hidedeny = true ; hideend = true ; mute = true ; hidevideo = true ; 
