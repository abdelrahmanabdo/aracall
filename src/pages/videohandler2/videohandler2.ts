...
@Component({
  selector: 'page-videohandler2',
  templateUrl: 'videohandler2.html',
})
export class Videohandler2Page {
   @ViewChild('localVideo') localVideo;
  @ViewChild('selfVideo') selfVideo;
number ;remotename;hideavatar = false;remoteavatar ; hidetext = true ; text ="Connecting" ;  incoming ; hideaccept = true ; hidedeny = true ; hideend = true ; mute = true ; hidevideo = true ; 
  constructor(public events:Events,public navCtrl: NavController, public navParams: NavParams,public db:DatabaseProvider) {
